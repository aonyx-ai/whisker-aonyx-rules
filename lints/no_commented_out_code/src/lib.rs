...
///
/// ```
/// use no_commented_out_code::NoCommentedOutCode;
/// use whisker_rust::RustLintPassAdapter;
///
/// let pass = RustLintPassAdapter::new(NoCommentedOutCode::new());
/// ```
pub struct NoCommentedOutCode {
    parser: Parser,
}

impl NoCommentedOutCode {
    ...
    /// use no_commented_out_code::NoCommentedOutCode;
    ///
    /// let rule = NoCommentedOutCode::new();
    /// ```
    pub fn new() -> Self {
    ...
    fn report(&mut self, body: &str, span: Span) -> Vec<Diagnostic> {
        match classify(&mut self.parser, body) {
            Fragment::Code => vec![Diagnostic::new(
                RuleId::new("lint.no-commented-out-code"),
                Severity::Warn,
...
impl Default for NoCommentedOutCode {
    fn default() -> Self {
        Self::new()
    }
}

impl RustLintPass for NoCommentedOutCode {
...
mod tests {
    ...
    fn passes() -> Vec<Box<dyn LintPass>> {
        vec![Box::new(
            RustLintPassAdapter::new(NoCommentedOutCode::new()),
        )]
    }
    ...
    fn commented_out_function_is_flagged() {
        ...
        assert_diagnostic(&diagnostics[0])
            .has_rule_id("lint.no-commented-out-code")
    ...
    fn trait_send() {
        ...
        assert_send::<NoCommentedOutCode>();
    ...
    fn trait_sync() {
        ...
        assert_sync::<NoCommentedOutCode>();
    ...
    fn trait_unpin() {
        ...
        assert_unpin::<NoCommentedOutCode>();
