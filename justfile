...
package-lints rev whisker:
    ...
    # The libraries are built with the toolchain this repository pins.
    # Whisker loads a library regardless of which rustc built it, so the
    # choice is this repository's own.
